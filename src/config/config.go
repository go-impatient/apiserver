...
func (c *Config) initConfig() (ConfYaml, error) {
	...
	confYaml.Core.TLS.CertBase64 = viper.GetString("core.tls.cert_base64")
	confYaml.Core.TLS.KeyBase64 = viper.GetString("core.tls.key_base64")
